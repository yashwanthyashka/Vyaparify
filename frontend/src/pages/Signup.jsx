    ...
    <div className="min-h-screen bg-gray-900 flex items-center justify-center px-4 py-12 relative overflow-hidden">
      ...
      <div className="relative max-w-md w-full">
        ...
        <div className="relative bg-gray-800/50 backdrop-blur-xl rounded-2xl border border-white/10 shadow-2xl shadow-black/40 p-8 overflow-hidden">
          ...
          {error && (
            <div className="mt-6 bg-red-500/10 border border-red-500/50 text-red-400 rounded-xl p-4 text-sm backdrop-blur-xl animate-fadeIn">
              {error}
            </div>
          )}
            ...
            <div className="space-y-4">
              ...
              <div className="group relative">
                ...
                <div className="relative">
                  <User className="absolute left-3 top-3 h-5 w-5 text-gray-400 group-hover:text-emerald-400 transition-colors" />
                  <input
                    type="text"
                    required
                    value={name}
